...
//
// To regenerate:
//   ./target/release/framec compile -l rust -o /tmp framec/src/frame_c/compiler/import_scanner/c_import.frs
//   cp /tmp/c_import.rs framec/src/frame_c/compiler/import_scanner/c_import.gen.rs
