...
struct CppImportScannerFsmCompartment {
    state: String,
    state_context: CppImportScannerFsmStateContext,
...
pub struct CppImportScannerFsm {
    _state_stack: Vec<CppImportScannerFsmCompartment>,
...
impl CppImportScannerFsm {
    pub fn new() -> Self {
        ...
        let __ctx = CppImportScannerFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: CppImportScannerFsmCompartment) {
    ...
    pub fn do_scan(&mut self) {
        ...
        let mut __ctx = CppImportScannerFsmFrameContext::new(__e, None);
