...
struct JavaImportScannerFsmCompartment {
    state: String,
    state_context: JavaImportScannerFsmStateContext,
...
pub struct JavaImportScannerFsm {
    _state_stack: Vec<JavaImportScannerFsmCompartment>,
...
impl JavaImportScannerFsm {
    pub fn new() -> Self {
        ...
        let __ctx = JavaImportScannerFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: JavaImportScannerFsmCompartment) {
    ...
    pub fn do_scan(&mut self) {
        ...
        let mut __ctx = JavaImportScannerFsmFrameContext::new(__e, None);
