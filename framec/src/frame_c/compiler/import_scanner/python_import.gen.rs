...
struct PythonImportScannerFsmCompartment {
    state: String,
    state_context: PythonImportScannerFsmStateContext,
...
pub struct PythonImportScannerFsm {
    _state_stack: Vec<PythonImportScannerFsmCompartment>,
...
impl PythonImportScannerFsm {
    pub fn new() -> Self {
        ...
        let __ctx = PythonImportScannerFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: PythonImportScannerFsmCompartment) {
    ...
    pub fn do_scan(&mut self) {
        ...
        let mut __ctx = PythonImportScannerFsmFrameContext::new(__e, None);
