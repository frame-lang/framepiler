...
struct CImportScannerFsmCompartment {
    state: String,
    state_context: CImportScannerFsmStateContext,
...
pub struct CImportScannerFsm {
    _state_stack: Vec<CImportScannerFsmCompartment>,
...
impl CImportScannerFsm {
    pub fn new() -> Self {
        ...
        let __ctx = CImportScannerFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: CImportScannerFsmCompartment) {
    ...
    pub fn do_scan(&mut self) {
        ...
        let mut __ctx = CImportScannerFsmFrameContext::new(__e, None);
