...
struct RustImportScannerFsmCompartment {
    state: String,
    state_context: RustImportScannerFsmStateContext,
...
pub struct RustImportScannerFsm {
    _state_stack: Vec<RustImportScannerFsmCompartment>,
...
impl RustImportScannerFsm {
    pub fn new() -> Self {
        ...
        let __ctx = RustImportScannerFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: RustImportScannerFsmCompartment) {
    ...
    pub fn do_scan(&mut self) {
        ...
        let mut __ctx = RustImportScannerFsmFrameContext::new(__e, None);
