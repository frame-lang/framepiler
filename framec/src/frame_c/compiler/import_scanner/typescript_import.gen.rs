...
struct TypeScriptImportScannerFsmCompartment {
    state: String,
    state_context: TypeScriptImportScannerFsmStateContext,
...
pub struct TypeScriptImportScannerFsm {
    _state_stack: Vec<TypeScriptImportScannerFsmCompartment>,
...
impl TypeScriptImportScannerFsm {
    pub fn new() -> Self {
        ...
        let __ctx = TypeScriptImportScannerFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: TypeScriptImportScannerFsmCompartment) {
    ...
    pub fn do_scan(&mut self) {
        ...
        let mut __ctx = TypeScriptImportScannerFsmFrameContext::new(__e, None);
