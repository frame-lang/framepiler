...
use super::ast::{MachineDecl, Span, StateDecl, SystemDecl};
use super::frame_ast::{
...
pub struct SystemEntry {
    ...
    /// True if any interface method is declared async — triggers async dispatch chain
