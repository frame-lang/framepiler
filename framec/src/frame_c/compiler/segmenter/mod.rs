...
mod tests {
    ...
    // ========================================================================
    // Adversarial tests: language-specific strings containing @@system
    // These verify each language's skipper correctly ignores @@system inside
    // strings/comments in the prolog region.
    // ========================================================================
