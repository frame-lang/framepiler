// Body closer for Java language — Frame-generated state machine.
//
// Source: java.frs (Frame specification)
// Generated: java.gen.rs (via framec --target rust)
// This file: glue module wiring generated FSM to BodyCloser trait
//
// To regenerate:
//   ./target/release/framec framec/src/frame_c/compiler/body_closer/java.frs -l rust > framec/src/frame_c/compiler/body_closer/java.gen.rs
...
impl BodyCloser for BodyCloserJava {
    fn close_byte(&mut self, bytes: &[u8], open_brace_index: usize) -> Result<usize, CloseError> {
        let mut fsm = JavaBodyCloserFsm::new();
