...
// Dogfooded body closer — Java language brace matcher.
...
enum JavaBodyCloserFsmFrameEvent {
    Scan {  },
...
#[derive(Clone)]
#[allow(dead_code, non_camel_case_types)]
enum JavaBodyCloserFsmFrameReturn {
...
impl JavaBodyCloserFsmFrameEvent {
    fn name(&self) -> &'static str {
        match self {
            JavaBodyCloserFsmFrameEvent::Scan { .. } => "scan",
            JavaBodyCloserFsmFrameEvent::FrameEnter { .. } => "$>",
            JavaBodyCloserFsmFrameEvent::FrameExit { .. } => "<$",
        }
    }
}
...
#[derive(Clone, Debug)]
#[allow(dead_code)]
enum JavaBodyCloserFsmFrameValue {
    Int(i64),
    Float(f64),
    Bool(bool),
    Str(String),
...
struct JavaBodyCloserFsmFrameContext {
    event: std::rc::Rc<JavaBodyCloserFsmFrameEvent>,
    _return: Option<JavaBodyCloserFsmFrameReturn>,
    _data: std::collections::HashMap<String, JavaBodyCloserFsmFrameValue>,
    _transitioned: bool,
}

impl JavaBodyCloserFsmFrameContext {
    fn new(event: std::rc::Rc<JavaBodyCloserFsmFrameEvent>, default_return: Option<JavaBodyCloserFsmFrameReturn>) -> Self {
        Self {
            event,
...
struct JavaBodyCloserFsmCompartment {
    state: String,
    state_context: JavaBodyCloserFsmStateContext,
...
pub struct JavaBodyCloserFsm {
    _state_stack: Vec<JavaBodyCloserFsmCompartment>,
...
impl JavaBodyCloserFsm {
    ...
    pub fn __create() -> Self {
        ...
        let __e = std::rc::Rc::new(JavaBodyCloserFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
        let __ctx = JavaBodyCloserFsmFrameContext::new(std::rc::Rc::clone(&__e), None);
    ...
    fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<String>) -> JavaBodyCloserFsmCompartment {
        let chain = self.__hsm_chain(leaf);
        let mut comp: Option<JavaBodyCloserFsmCompartment> = None;
        for name in chain.iter() {
            let mut new_comp = JavaBodyCloserFsmCompartment::new(name);
    ...
    fn __kernel(&mut self, __e: &std::rc::Rc<JavaBodyCloserFsmFrameEvent>) {
        ...
        while self.__next_compartment.is_some() {
            ...
            let exit_event = std::rc::Rc::new(JavaBodyCloserFsmFrameEvent::FrameExit { args: exit_args });
            ...
            match self.__compartment.forward_event.take() {
                None => {
                    ...
                    let enter_event = std::rc::Rc::new(JavaBodyCloserFsmFrameEvent::FrameEnter { args: enter_args });
                    self.__router(&enter_event);
                }
                Some(fwd) if matches!(fwd, JavaBodyCloserFsmFrameEvent::FrameEnter { .. }) => {
    ...
    fn __router(&mut self, __e: &std::rc::Rc<JavaBodyCloserFsmFrameEvent>) {
        let __ev: &JavaBodyCloserFsmFrameEvent = &**__e;
    ...
    pub fn scan(&mut self) {
        let __e = std::rc::Rc::new(JavaBodyCloserFsmFrameEvent::Scan {});
        let mut __ctx = JavaBodyCloserFsmFrameContext::new(std::rc::Rc::clone(&__e), None);
    ...
    fn _state_Init(&mut self, __e: &JavaBodyCloserFsmFrameEvent) {
        match __e {
            JavaBodyCloserFsmFrameEvent::Scan { .. } => { self._s_Init_hdl_user_scan(__e); }
            _ => {}
        }
    }
    ...
    fn _state_Scanning(&mut self, __e: &JavaBodyCloserFsmFrameEvent) {
        match __e {
            JavaBodyCloserFsmFrameEvent::FrameEnter { .. } => { self._s_Scanning_hdl_frame_enter(__e); }
            _ => {}
        }
    }
    ...
    fn _state_InString(&mut self, __e: &JavaBodyCloserFsmFrameEvent) {
        match __e {
            JavaBodyCloserFsmFrameEvent::FrameEnter { .. } => { self._s_InString_hdl_frame_enter(__e); }
            _ => {}
        }
    }
    ...
    fn _state_InCharLiteral(&mut self, __e: &JavaBodyCloserFsmFrameEvent) {
        match __e {
            JavaBodyCloserFsmFrameEvent::FrameEnter { .. } => { self._s_InCharLiteral_hdl_frame_enter(__e); }
            _ => {}
        }
    }
    ...
    fn _state_InLineComment(&mut self, __e: &JavaBodyCloserFsmFrameEvent) {
        match __e {
            JavaBodyCloserFsmFrameEvent::FrameEnter { .. } => { self._s_InLineComment_hdl_frame_enter(__e); }
            _ => {}
        }
    }
    ...
    fn _state_InBlockComment(&mut self, __e: &JavaBodyCloserFsmFrameEvent) {
        match __e {
            JavaBodyCloserFsmFrameEvent::FrameEnter { .. } => { self._s_InBlockComment_hdl_frame_enter(__e); }
            _ => {}
        }
    }

    fn _s_Init_hdl_user_scan(&mut self, __e: &JavaBodyCloserFsmFrameEvent) {
        let mut __compartment = self.__prepareEnter("Scanning", vec![]);
        self.__transition(__compartment);
        return;
    }

    fn _s_Scanning_hdl_frame_enter(&mut self, __e: &JavaBodyCloserFsmFrameEvent) {
    ...
    fn _s_InString_hdl_frame_enter(&mut self, __e: &JavaBodyCloserFsmFrameEvent) {
        let n = self.bytes.len();
        while self.pos < n {
    ...
    fn _s_InCharLiteral_hdl_frame_enter(&mut self, __e: &JavaBodyCloserFsmFrameEvent) {
        let n = self.bytes.len();
        while self.pos < n {
            if self.bytes[self.pos] == b'\\' {
                self.pos += 2;
    ...
    fn _s_InLineComment_hdl_frame_enter(&mut self, __e: &JavaBodyCloserFsmFrameEvent) {
        let n = self.bytes.len();
    ...
    fn _s_InBlockComment_hdl_frame_enter(&mut self, __e: &JavaBodyCloserFsmFrameEvent) {
        let n = self.bytes.len();
        while self.pos + 1 < n {
