...
impl JavaBodyCloserFsm {
    pub fn new() -> Self {
        ...
        let __ctx = JavaBodyCloserFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: JavaBodyCloserFsmCompartment) {
    ...
    pub fn scan(&mut self) {
        ...
        let mut __ctx = JavaBodyCloserFsmFrameContext::new(__e, None);
