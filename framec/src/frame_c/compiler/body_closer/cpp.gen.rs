...
impl CppBodyCloserFsm {
    pub fn new() -> Self {
        ...
        let __ctx = CppBodyCloserFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: CppBodyCloserFsmCompartment) {
    ...
    pub fn scan(&mut self) {
        ...
        let mut __ctx = CppBodyCloserFsmFrameContext::new(__e, None);
