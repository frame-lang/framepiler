...
impl PythonBodyCloserFsm {
    pub fn new() -> Self {
        ...
        let __ctx = PythonBodyCloserFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: PythonBodyCloserFsmCompartment) {
    ...
    pub fn scan(&mut self) {
        ...
        let mut __ctx = PythonBodyCloserFsmFrameContext::new(__e, None);
