...
impl CBodyCloserFsm {
    pub fn new() -> Self {
        ...
        let __ctx = CBodyCloserFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: CBodyCloserFsmCompartment) {
    ...
    pub fn scan(&mut self) {
        ...
        let mut __ctx = CBodyCloserFsmFrameContext::new(__e, None);
