...
impl RustBodyCloserFsm {
    pub fn new() -> Self {
        ...
        let __ctx = RustBodyCloserFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: RustBodyCloserFsmCompartment) {
    ...
    pub fn scan(&mut self) {
        ...
        let mut __ctx = RustBodyCloserFsmFrameContext::new(__e, None);
