...
//
// To regenerate:
//   ./target/release/framec compile -l rust -o /tmp framec/src/frame_c/compiler/native_region_scanner/c_skipper.frs
//   cp /tmp/c_skipper.rs framec/src/frame_c/compiler/native_region_scanner/c_skipper.gen.rs
...
use super::unified::*;
use super::*;
use crate::frame_c::compiler::body_closer::c::BodyCloserC;
