...
enum ErlangSyntaxSkipperFsmFrameEvent {
    DoSkipComment {  },
    DoSkipString {  },
    DoFindLineEnd {  },
    DoBalancedParenEnd {  },
...
#[derive(Clone)]
#[allow(dead_code, non_camel_case_types)]
enum ErlangSyntaxSkipperFsmFrameReturn {
...
impl ErlangSyntaxSkipperFsmFrameEvent {
    fn name(&self) -> &'static str {
        match self {
            ErlangSyntaxSkipperFsmFrameEvent::DoSkipComment { .. } => "do_skip_comment",
            ErlangSyntaxSkipperFsmFrameEvent::DoSkipString { .. } => "do_skip_string",
            ErlangSyntaxSkipperFsmFrameEvent::DoFindLineEnd { .. } => "do_find_line_end",
            ErlangSyntaxSkipperFsmFrameEvent::DoBalancedParenEnd { .. } => "do_balanced_paren_end",
            ErlangSyntaxSkipperFsmFrameEvent::FrameEnter { .. } => "$>",
            ErlangSyntaxSkipperFsmFrameEvent::FrameExit { .. } => "<$",
        }
    }
}
...
#[derive(Clone, Debug)]
#[allow(dead_code)]
enum ErlangSyntaxSkipperFsmFrameValue {
    Int(i64),
    Float(f64),
    Bool(bool),
    Str(String),
...
struct ErlangSyntaxSkipperFsmFrameContext {
    event: std::rc::Rc<ErlangSyntaxSkipperFsmFrameEvent>,
    _return: Option<ErlangSyntaxSkipperFsmFrameReturn>,
    _data: std::collections::HashMap<String, ErlangSyntaxSkipperFsmFrameValue>,
    _transitioned: bool,
}

impl ErlangSyntaxSkipperFsmFrameContext {
    fn new(event: std::rc::Rc<ErlangSyntaxSkipperFsmFrameEvent>, default_return: Option<ErlangSyntaxSkipperFsmFrameReturn>) -> Self {
        Self {
            event,
...
impl ErlangSyntaxSkipperFsm {
    ...
    pub fn __create() -> Self {
        ...
        let __e = std::rc::Rc::new(ErlangSyntaxSkipperFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
        let __ctx = ErlangSyntaxSkipperFsmFrameContext::new(std::rc::Rc::clone(&__e), None);
    ...
    fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<String>) -> ErlangSyntaxSkipperFsmCompartment {
        ...
        for name in chain.iter() {
            let mut new_comp = ErlangSyntaxSkipperFsmCompartment::new(name);
    ...
    fn __kernel(&mut self, __e: &std::rc::Rc<ErlangSyntaxSkipperFsmFrameEvent>) {
        ...
        while self.__next_compartment.is_some() {
            ...
            let exit_event = std::rc::Rc::new(ErlangSyntaxSkipperFsmFrameEvent::FrameExit { args: exit_args });
            ...
            match self.__compartment.forward_event.take() {
                None => {
                    ...
                    let enter_event = std::rc::Rc::new(ErlangSyntaxSkipperFsmFrameEvent::FrameEnter { args: enter_args });
                    self.__router(&enter_event);
                }
                Some(fwd) if matches!(fwd, ErlangSyntaxSkipperFsmFrameEvent::FrameEnter { .. }) => {
    ...
    pub fn do_skip_comment(&mut self) {
        let __e = std::rc::Rc::new(ErlangSyntaxSkipperFsmFrameEvent::DoSkipComment {});
        let mut __ctx = ErlangSyntaxSkipperFsmFrameContext::new(std::rc::Rc::clone(&__e), None);
    ...
    pub fn do_skip_string(&mut self) {
        let __e = std::rc::Rc::new(ErlangSyntaxSkipperFsmFrameEvent::DoSkipString {});
        let mut __ctx = ErlangSyntaxSkipperFsmFrameContext::new(std::rc::Rc::clone(&__e), None);
        self._context_stack.push(__ctx);
        self.__kernel(&__e);
        self._context_stack.pop();
    ...
    pub fn do_find_line_end(&mut self) {
        let __e = std::rc::Rc::new(ErlangSyntaxSkipperFsmFrameEvent::DoFindLineEnd {});
        let mut __ctx = ErlangSyntaxSkipperFsmFrameContext::new(std::rc::Rc::clone(&__e), None);
        self._context_stack.push(__ctx);
        self.__kernel(&__e);
        self._context_stack.pop();
    ...
    pub fn do_balanced_paren_end(&mut self) {
        let __e = std::rc::Rc::new(ErlangSyntaxSkipperFsmFrameEvent::DoBalancedParenEnd {});
        let mut __ctx = ErlangSyntaxSkipperFsmFrameContext::new(std::rc::Rc::clone(&__e), None);
        self._context_stack.push(__ctx);
        self.__kernel(&__e);
        self._context_stack.pop();
    ...
    fn _state_Init(&mut self, __e: &ErlangSyntaxSkipperFsmFrameEvent) {
        match __e {
            ErlangSyntaxSkipperFsmFrameEvent::DoBalancedParenEnd { .. } => { self._s_Init_hdl_user_do_balanced_paren_end(__e); }
            ErlangSyntaxSkipperFsmFrameEvent::DoFindLineEnd { .. } => { self._s_Init_hdl_user_do_find_line_end(__e); }
            ErlangSyntaxSkipperFsmFrameEvent::DoSkipComment { .. } => { self._s_Init_hdl_user_do_skip_comment(__e); }
            ErlangSyntaxSkipperFsmFrameEvent::DoSkipString { .. } => { self._s_Init_hdl_user_do_skip_string(__e); }
            _ => {}
        }
    }
    ...
    fn _state_SkipComment(&mut self, __e: &ErlangSyntaxSkipperFsmFrameEvent) {
        match __e {
            ErlangSyntaxSkipperFsmFrameEvent::FrameEnter { .. } => { self._s_SkipComment_hdl_frame_enter(__e); }
            _ => {}
        }
    }
    ...
    fn _state_SkipString(&mut self, __e: &ErlangSyntaxSkipperFsmFrameEvent) {
        match __e {
            ErlangSyntaxSkipperFsmFrameEvent::FrameEnter { .. } => { self._s_SkipString_hdl_frame_enter(__e); }
            _ => {}
        }
    }
    ...
    fn _state_FindLineEnd(&mut self, __e: &ErlangSyntaxSkipperFsmFrameEvent) {
        match __e {
            ErlangSyntaxSkipperFsmFrameEvent::FrameEnter { .. } => { self._s_FindLineEnd_hdl_frame_enter(__e); }
            _ => {}
        }
    }
    ...
    fn _state_BalancedParenEnd(&mut self, __e: &ErlangSyntaxSkipperFsmFrameEvent) {
        match __e {
            ErlangSyntaxSkipperFsmFrameEvent::FrameEnter { .. } => { self._s_BalancedParenEnd_hdl_frame_enter(__e); }
            _ => {}
        }
    }

    fn _s_Init_hdl_user_do_balanced_paren_end(&mut self, __e: &ErlangSyntaxSkipperFsmFrameEvent) {
        let mut __compartment = self.__prepareEnter("BalancedParenEnd", vec![]);
        self.__transition(__compartment);
        return;
    }

    fn _s_Init_hdl_user_do_find_line_end(&mut self, __e: &ErlangSyntaxSkipperFsmFrameEvent) {
        let mut __compartment = self.__prepareEnter("FindLineEnd", vec![]);
        self.__transition(__compartment);
        return;
    }

    fn _s_Init_hdl_user_do_skip_comment(&mut self, __e: &ErlangSyntaxSkipperFsmFrameEvent) {
        let mut __compartment = self.__prepareEnter("SkipComment", vec![]);
        self.__transition(__compartment);
        return;
    }

    fn _s_Init_hdl_user_do_skip_string(&mut self, __e: &ErlangSyntaxSkipperFsmFrameEvent) {
        let mut __compartment = self.__prepareEnter("SkipString", vec![]);
        self.__transition(__compartment);
        return;
    }

    fn _s_SkipComment_hdl_frame_enter(&mut self, __e: &ErlangSyntaxSkipperFsmFrameEvent) {
    ...
    fn _s_SkipString_hdl_frame_enter(&mut self, __e: &ErlangSyntaxSkipperFsmFrameEvent) {
    ...
    fn _s_FindLineEnd_hdl_frame_enter(&mut self, __e: &ErlangSyntaxSkipperFsmFrameEvent) {
        let end = self.end;
    ...
    fn _s_BalancedParenEnd_hdl_frame_enter(&mut self, __e: &ErlangSyntaxSkipperFsmFrameEvent) {
        let end = self.end;
        let bytes = &self.bytes;
        let mut i = self.pos;
        if i >= end || bytes[i] != b'(' {
