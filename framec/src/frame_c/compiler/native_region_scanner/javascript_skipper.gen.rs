...
#[allow(dead_code)]
struct JavaScriptSyntaxSkipperFsmFrameEvent {
    message: String,
    parameters: std::collections::HashMap<String, Box<dyn std::any::Any>>,
}

impl Clone for JavaScriptSyntaxSkipperFsmFrameEvent {
    fn clone(&self) -> Self {
        Self {
...
impl JavaScriptSyntaxSkipperFsmFrameContext {
    fn new(event: JavaScriptSyntaxSkipperFsmFrameEvent, default_return: Option<Box<dyn std::any::Any>>) -> Self {
        Self {
            event,
...
impl JavaScriptSyntaxSkipperFsm {
    pub fn new() -> Self {
        ...
        let __frame_event = JavaScriptSyntaxSkipperFsmFrameEvent::new("$>");
        let __ctx = JavaScriptSyntaxSkipperFsmFrameContext::new(__frame_event, None);
    ...
    fn __kernel(&mut self) {
        ...
        while self.__next_compartment.is_some() {
            ...
            let exit_event = JavaScriptSyntaxSkipperFsmFrameEvent::new_with_params("<$", &self.__compartment.exit_args);
            self.__router(&exit_event);
            // Switch to new compartment
            self.__compartment = next_compartment;
            // Enter new state (or forward event)
            if self.__compartment.forward_event.is_none() {
                let enter_event = JavaScriptSyntaxSkipperFsmFrameEvent::new_with_params("$>", &self.__compartment.enter_args);
    ...
    fn __router(&mut self, __e: &JavaScriptSyntaxSkipperFsmFrameEvent) {
    ...
    fn __push_transition(&mut self, new_compartment: JavaScriptSyntaxSkipperFsmCompartment) {
    ...
    pub fn do_skip_comment(&mut self) {
        let mut __e = JavaScriptSyntaxSkipperFsmFrameEvent::new("do_skip_comment");
        let mut __ctx = JavaScriptSyntaxSkipperFsmFrameContext::new(__e, None);
    ...
    pub fn do_skip_string(&mut self) {
        let mut __e = JavaScriptSyntaxSkipperFsmFrameEvent::new("do_skip_string");
        let mut __ctx = JavaScriptSyntaxSkipperFsmFrameContext::new(__e, None);
        self._context_stack.push(__ctx);
        self.__kernel();
        self._context_stack.pop();
    ...
    pub fn do_find_line_end(&mut self) {
        let mut __e = JavaScriptSyntaxSkipperFsmFrameEvent::new("do_find_line_end");
        let mut __ctx = JavaScriptSyntaxSkipperFsmFrameContext::new(__e, None);
        self._context_stack.push(__ctx);
        self.__kernel();
        self._context_stack.pop();
    ...
    pub fn do_balanced_paren_end(&mut self) {
        let mut __e = JavaScriptSyntaxSkipperFsmFrameEvent::new("do_balanced_paren_end");
        let mut __ctx = JavaScriptSyntaxSkipperFsmFrameContext::new(__e, None);
        self._context_stack.push(__ctx);
        self.__kernel();
        self._context_stack.pop();
    ...
    fn _s_BalancedParenEnd_enter(&mut self, __e: &JavaScriptSyntaxSkipperFsmFrameEvent) {
