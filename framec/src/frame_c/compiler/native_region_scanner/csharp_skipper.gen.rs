...
impl CSharpSyntaxSkipperFsm {
    pub fn new() -> Self {
        ...
        let __ctx = CSharpSyntaxSkipperFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: CSharpSyntaxSkipperFsmCompartment) {
    ...
    pub fn do_skip_comment(&mut self) {
        ...
        let mut __ctx = CSharpSyntaxSkipperFsmFrameContext::new(__e, None);
