...
impl ExprScannerFsm {
    pub fn new() -> Self {
        ...
        let __ctx = ExprScannerFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: ExprScannerFsmCompartment) {
    ...
    pub fn do_scan(&mut self) {
        ...
        let mut __ctx = ExprScannerFsmFrameContext::new(__e, None);
