...
impl TypeScriptSyntaxSkipperFsm {
    pub fn new() -> Self {
        ...
        let __ctx = TypeScriptSyntaxSkipperFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: TypeScriptSyntaxSkipperFsmCompartment) {
    ...
    pub fn do_skip_comment(&mut self) {
        ...
        let mut __ctx = TypeScriptSyntaxSkipperFsmFrameContext::new(__e, None);
