...
impl JavaSyntaxSkipperFsm {
    pub fn new() -> Self {
        ...
        let __ctx = JavaSyntaxSkipperFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: JavaSyntaxSkipperFsmCompartment) {
    ...
    pub fn do_skip_comment(&mut self) {
        ...
        let mut __ctx = JavaSyntaxSkipperFsmFrameContext::new(__e, None);
