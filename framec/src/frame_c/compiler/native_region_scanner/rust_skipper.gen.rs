...
impl RustSyntaxSkipperFsm {
    pub fn new() -> Self {
        ...
        let __ctx = RustSyntaxSkipperFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: RustSyntaxSkipperFsmCompartment) {
    ...
    pub fn do_skip_comment(&mut self) {
        ...
        let mut __ctx = RustSyntaxSkipperFsmFrameContext::new(__e, None);
