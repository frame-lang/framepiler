...
impl CppSyntaxSkipperFsm {
    pub fn new() -> Self {
        ...
        let __ctx = CppSyntaxSkipperFsmFrameContext::new(__frame_event, None);
    ...
    fn __push_transition(&mut self, new_compartment: CppSyntaxSkipperFsmCompartment) {
    ...
    pub fn do_skip_comment(&mut self) {
        ...
        let mut __ctx = CppSyntaxSkipperFsmFrameContext::new(__e, None);
