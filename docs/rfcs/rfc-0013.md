...
- 2026-05-01 — Wave 2 Phase 2 (per-item attachment positions)
  ...
  Domain-field attribute attachment is deferred — domain parsing
  uses a byte-walker rather than the token stream. Validator codes
  E800 (unknown attribute) and E801 (attribute at wrong position)
  also deferred to a follow-up; today an unknown attribute is
  silently ignored.
